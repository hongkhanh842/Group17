                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="product-page1">
                            <img src="{{asset('assets')}}/home/img/examples/product1.jpg"/>
                        </div>
                        <div class="tab-pane active" id="product-page2">
                            <img src="{{asset('assets')}}/home/img/examples/product2.jpg"/>
                        </div>
                        <div class="tab-pane" id="product-page3">
                            <img src="{{asset('assets')}}/home/img/examples/product3.jpg"/>
                        </div>
                        <div class="tab-pane" id="product-page4">
                            <img src="{{asset('assets')}}/home/img/examples/product4.jpg"/>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <div class="card card-product">
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img" src="{{asset('assets')}}/home/img/examples/card-product1.jpg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card card-product">
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img" src="{{asset('assets')}}/home/img/examples/card-product3.jpg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card card-product">
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img" src="{{asset('assets')}}/home/img/examples/card-product4.jpg" />
                            </a>
                        </div>
                ...
                <div class="col-sm-6 col-md-3">
                    <div class="card card-product">
                        <div class="card-image">
                            <a href="#pablo">
                                <img class="img" src="{{asset('assets')}}/home/img/examples/card-product2.jpg" />
                            </a>
                        </div>
